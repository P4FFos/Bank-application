...
public class CustomerLoansApplicationController extends CustomerStartController {
    ...
    @FXML
    private Label enterYearsLabel;

    @FXML
    private TextField enterYearsTextField;

    @FXML
    private CheckBox firstAmountCheckBox;

    @FXML
    private CheckBox firstPeriodCheckBox;

    @FXML
    private CheckBox fourthAmountCheckBox;

    @FXML
    private CheckBox fourthPeriodCheckBox;
    ...
    @FXML
    private AnchorPane loanApplicationAnchorPane;

    @FXML
    private Label loanApplicationLabel;
    ...
    @FXML
    private Label repaymentPeriodHintLabel;
    ...
    @FXML
    private CheckBox secondPeriodCheckBox;
    ...
    @FXML
    private CheckBox thirdPeriodCheckBox;
